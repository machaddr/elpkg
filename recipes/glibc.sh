...
pkgrel=1
arch=("i686")
source=("https://ftpmirror.gnu.org/gnu/glibc/glibc-2.42.tar.xz")
sha256sums=("d1775e32e4628e64ef930f435b67bb63af7599acb6be2b335b9f19f16509f17f")
depends=()

makedepends=("bash" "binutils" "bison" "coreutils" "diffutils" "gawk" "gcc" "gettext" "grep" "gzip" "linux-api-headers" "make" "perl" "python" "sed" "texinfo")
description="glibc"

build() {
cd $srcdir
tar -xf $srcdir/glibc-$pkgver.tar.xz
...
patch -Np1 -i $patchdir/glibc-2.42-fhs-1.patch

mkdir -v $srcdir/glibc-$pkgver/build && \
